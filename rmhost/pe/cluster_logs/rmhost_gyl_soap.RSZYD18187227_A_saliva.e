...
rule rmhost_gyl_soap:
    ...
    output: results/RSZYD18187227_A_saliva.gyl_soap.rmhost.1.fq.gz, results/RSZYD18187227_A_saliva.gyl_soap.rmhost.2.fq.gz
    log: logs/RSZYD18187227_A_saliva.gyl_soap.rmhost.log
    jobid: 0
    benchmark: benchmark/RSZYD18187227_A_saliva.gyl_soap.rmhost.benchmark.txt
    wildcards: sample=RSZYD18187227_A_saliva
    threads: 8

[Sun Feb 24 10:44:37 2019]
Finished job 0.
