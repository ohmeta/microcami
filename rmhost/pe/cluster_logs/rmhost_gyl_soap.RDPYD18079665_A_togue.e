...
rule rmhost_gyl_soap:
    ...
    output: results/RDPYD18079665_A_togue.gyl_soap.rmhost.1.fq.gz, results/RDPYD18079665_A_togue.gyl_soap.rmhost.2.fq.gz
    log: logs/RDPYD18079665_A_togue.gyl_soap.rmhost.log
    jobid: 0
    benchmark: benchmark/RDPYD18079665_A_togue.gyl_soap.rmhost.benchmark.txt
    wildcards: sample=RDPYD18079665_A_togue
    threads: 8

[Sun Feb 24 09:46:40 2019]
Finished job 0.
